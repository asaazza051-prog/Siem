...
def _extract_action(result):
    ...
    if "added" in t or "created" in t: return "THÊM MỚI"
    if "deleted" in t: return "BỊ XÓA"
    if "modified" in t or "integrity checksum changed" in t: return "SỬA ĐỔI"
    return "THAY ĐỔI"
